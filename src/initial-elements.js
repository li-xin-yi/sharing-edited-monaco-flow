...
{id : '9'
, data : {label : 'Code:', id : 'prefix-9', user: user, color: color}, type: 'monacoNode', position: { x: 200, y: 400}},

{id : '10'
, data : {label : 'Code:', id : 'prefix-10', user: user, color: color}, type: 'monacoNode', position: { x: 600, y: 100}},
]);}
